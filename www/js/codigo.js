...
function AgregarMovimiento(mov){
  fetch(`${URLBASE}movimientos.php`, {
    ...
    .then(function (dato) {
        console.log(dato);
        if(mov.categoria<7) dqs("pGasto").innerHTML = dato.mensaje;
        else dqs("pIngreso").innerHTML = dato.mensaje;
      })
    .catch(function (error) {
        console.log(error);      
    });
...
function TomarDatosRegistro() {
    ...
    fetch(`${URLBASE}usuarios.php`, {
      ...
      .catch(function (error) {
        console.log(error);
        dqs("pRegistroRes").innerHTML = "Datos incorrectos";
      });
  }
  ...
  function CrearMapa() {
    ...
    fetch(`${URLBASE}cajeros.php`, {
      ...
      .then(function (dato) {
          ...
          if(getDistanciaMetros(c.latitud,c.longitud,MiLat,MiLong)<1000){
